...
e9;V f=p;f.z=0;char l[]="=W=_5W=W5_=_5O5W5O=OEOMOEOE_E_M_MOM_UOU_eOe_]WeW]_e_]W]_";
for(I i=0;i<56;i+=4){V b=V(l[i]-79,l[i+1]-79)*.5,e=V(l[i+2]-79,l
[i+3]-79)*.5+b*-1,o=f+(b+e*L(-L((b+f*-1)%e/(e%e),0),1))*-1;d=L(d,o%o);}d=sq\
rtf(d);d=powf(powf(d,8)+powf(p.z,
...
R r;}I main(){I w=960,h=540,s=256;V e(-22,5,25),g=!(V(-3,4,0)+e*-1),l=!V(g.z,
